...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">قائمة الفواتير</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ ارشيف الفواتير</span>
						</div>
					</div>
				...
				<div class="row">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu tx-13">
                                                            ...
                                                            <a class="dropdown-item" href="#" data-invoice_id =" {{$invoice->id}}"
                                                               ...
                                                               data-toggle="modal" data-target="#Transfer_invoice"><i class="fa-money-bill"></i>   نقل الي الفواتير </a>
                    ...
                    <div class="modal" id="Transfer_invoice">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content modal-content-demo">
                                <div class="modal-header">
                                    <h6 class="modal-title">الغاء ارشفة  الفاتوره</h6><button aria-label="Close" class="close" data-dismiss="modal"
                                                                                  type="button"><span aria-hidden="true">&times;</span></button>
                                </div>
                                <form action="{{route('Archive.update','test')}}" method="post">
                                    ...
                                    {{csrf_field()}}
                                    <div class="modal-body">
                                        <p>هل انت متاكد من نقل الي الفواتير ؟</p><br>
                                        <input type="hidden" name="invoice_id" id="invoice_id" value="">
